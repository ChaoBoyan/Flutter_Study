...
class listViewDemo extends StatelessWidget {
  ...
  final List<String> cellDate = [
    "AppBaeDemo","DefaultTabController","ContainerDemo","PageViewDemo","PageVieBuildwDemo","GridViewDemo","SliverViewDemo","2","1","2","1","2","1","2","1","2"
  ];
  ...
  void  gotoAppBarDemoWidget(BuildContext context,int index){
    switch (index){
      ...
      case 5:
        ...
        break;
      case 6:
        Navigator.push(context, MaterialPageRoute(builder: (context)=>SliverViewDemo()));
        break;
    }
